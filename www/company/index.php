...
$APPLICATION->SetTitle("Компания SvetSadPark.ru » Производство и продажа садово-парковых светильников");

$APPLICATION->SetPageProperty('description', 'Интернет-магазин SvetSadPark.ru поможет приобрести уличные светильники. SvetSadPark.ru - владелец торговой марки O.L. И официальный диллер UME и LUTEC в России.');
$APPLICATION->SetPageProperty('keywords', 'SvetSadPark, SvetSadPark.ru, компания по производству светильников, магазин по продаже садовых светильников, магазин паркового освещения, магазин садового освещения, компания садово-паркового освещения');
?>
<script>
    $(function () {
        $("#sertif").fancybox({});
...
<div class="1inside_page_content"> 	 
  ...
  <p> 
    ...
    <div class="wrap_sectif">
        <blockquote style="width: 130px; float:left;    margin: 0px;">
            <b>Телефоны:</b>
            <p class="phone_alloka">8-800-775-12-05</p>
<!--            <p>8-499-550-15-29</p>-->
        </blockquote>
...
<script type="text/javascript" charset="utf-8" src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=rjh2op8vRIXLG6xzT76zCJxzlC2uR107&width=600&height=450"></script>
 	</div>
 </div>
