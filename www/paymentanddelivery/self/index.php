        ...
        <div class="global-content-block">
            <div class="bx_page">
                <div class="inside_page_content">
                    ...
                    <p>Самовывоз осуществляется только <b>после предварительного согласования</b> со специалистом
                        Интернет-магазина, так как заказанный Вами товар должен быть доставлен со склада в салон. </p>

                    <p>При оформлении заказа указывайте в соответствующем поле, что Вы хотели бы забрать заказ
                        самовывозом. После получения заказа Интернет-магазином, с <b>Вами свяжется наш специалист для
                            подтверждения заказа</b> и уточнения предполагаемой даты самовывоза. </p>
