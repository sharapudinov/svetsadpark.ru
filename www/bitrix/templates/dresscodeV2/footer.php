				...
				<div class="limiter">
					<div class="creator">
						<?if(!empty($TEMPLATE_FOOTER_VARIANT) && ($TEMPLATE_FOOTER_VARIANT == "6" || $TEMPLATE_FOOTER_VARIANT == "7")):?>
							<a href="https://seocontext.digital/"><img src="<?=SITE_TEMPLATE_PATH?>/images/dwC.png" alt="Digital Web"></a>
						<?elseif(!empty($TEMPLATE_FOOTER_VARIANT) && ($TEMPLATE_FOOTER_VARIANT == "4" || $TEMPLATE_FOOTER_VARIANT == "5" || $TEMPLATE_FOOTER_VARIANT == "6")):?>
							<a href="https://seocontext.digital/"><img src="<?=SITE_TEMPLATE_PATH?>/images/dwW.png" alt="Digital Web"></a>
						<?else:?>
                            <a href="https://seocontext.digital/"><img style="width: 60px;" src="<?=SITE_TEMPLATE_PATH?>/images/856b7ceb23c92fcfe574d77f576103d3.jpg" alt="Digital Web"></a>
