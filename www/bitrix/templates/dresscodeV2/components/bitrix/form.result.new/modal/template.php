...
<a href="#"
   class="openWebFormModal<? if (!empty($arParams["MODAL_BUTTON_CLASS_NAME"])): ?> <?= $arParams["MODAL_BUTTON_CLASS_NAME"] ?><? endif; ?>"
   data-id="<?= $arResult["arForm"]["ID"] ?>"><? if (empty($arParams["MODAL_BUTTON_NAME"])): ?><?= $arResult["FORM_TITLE"] ?><? else: ?><?= $arParams["MODAL_BUTTON_NAME"] ?><? endif; ?></a>
                                ...
                                <div class="personalInfo">
                                    <div class="webFormItem">
                                        ...
                                        <div class="webFormItemField" data-required="Y">
                                            <input type="checkbox" id="personalInfoField" name="personalInfo" value="Y"><label
                                                    for="personalInfoField"><?= getMessage("PERSONAL_INFO_REQUIRED") ?>
                            ...
                            <div class="tb">
                                <div class="tc">
                                    <input <?= (intval($arResult["F_RIGHT"]) < 10 ? "disabled=\"disabled\"" : ""); ?>
                                            ...
                                            class="sendWebFormDw"
                                            onclick="yaCounter42154374.reachGoal('call_back_btn');return(true)"/>
