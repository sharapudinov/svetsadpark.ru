		...
		if(!empty($PRODUCT_ID)){
			...
			if($arResult["EXIST_SKU"]){
				...
				if (is_array($SKU_INFO)){
					...
					$rsOffers = CIBlockElement::GetList(array(), $arOffersFilter, false, false, array("ID", "IBLOCK_ID", "DETAIL_PAGE_URL", "DETAIL_PICTURE", "NAME", "CATALOG_QUANTITY", "CATALOG_MEASURE")); 
