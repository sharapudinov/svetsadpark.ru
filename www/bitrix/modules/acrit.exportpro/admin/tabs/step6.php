...
elseif( $arProfile["TYPE"] == "ua_prom_ua" ){
    $iActualCategoryType = 4;
}
...
<?if( $bUseMarketCategoiesSettings ){?>
    ...
    if( ( $selectedMarketCategory != 3 ) && ( $selectedMarketCategory != 4 ) )
            ...
            <div id="market_category_list" style="display: none">
                ...
                <select onclick="SetMarketCategory( this.value )" size="25">
                    ...
                    <?foreach( $arMarketCategoryList as $marketCat ){?>
                        <option data-search="<?=( ( ( $selectedMarketCategory == 3 ) || ( $selectedMarketCategory == 4 ) ) ? strtolower( $marketCat["NAME"] ) : strtolower( $marketCat ) );?>"><?=( ( ( $selectedMarketCategory == 3 ) || ( $selectedMarketCategory == 4 ) ) ? $marketCat["NAME"] : $marketCat )?></option>
                    <?}?>
                </select>
            </div>
        </td>
