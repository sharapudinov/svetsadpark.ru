	...
	*/
	public static function GetControls($strControlID = false)
	{
		...
		$arControlList = array(/*
			...
			/*'CondIBMaxPrice' => array(
				'ID' => 'CondIBMaxPrice',
				'FIELD' => 'MaxPrice',
				'FIELD_TYPE' => 'int',
				'LABEL' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MAX_PRICE'),
				'PREFIX' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MAX_PRICE_PREFIX'),
			...
			'CondIBMinPrice' => array(
				'ID' => 'CondIBMinPrice',
				'FIELD' => 'MinPrice',
				'FIELD_TYPE' => 'int',
				'LABEL' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MIN_PRICE'),
				'PREFIX' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MIN_PRICE_PREFIX'),
				'LOGIC' => static::GetLogic(array(BT_COND_LOGIC_EQ, BT_COND_LOGIC_NOT_EQ, BT_COND_LOGIC_GR, BT_COND_LOGIC_LS, BT_COND_LOGIC_EGR, BT_COND_LOGIC_ELS)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
			...
			'CondIBMaxFilterPrice' => array(
				'ID' => 'CondIBMaxFilterPrice',
				'FIELD' => 'MaxFilterPrice',
				'FIELD_TYPE' => 'int',
				'LABEL' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MAX_FILTER_PRICE'),
				'PREFIX' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MAX_FILTER_PRICE_PREFIX'),
				'LOGIC' => static::GetLogic(array(BT_COND_LOGIC_EQ, BT_COND_LOGIC_NOT_EQ, BT_COND_LOGIC_GR, BT_COND_LOGIC_LS, BT_COND_LOGIC_EGR, BT_COND_LOGIC_ELS)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
			...
			'CondIBMinFilterPrice' => array(
				'ID' => 'CondIBMinFilterPrice',
				'FIELD' => 'MinFilterPrice',
				'FIELD_TYPE' => 'int',
				'LABEL' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MIN_FILTER_PRICE'),
				'PREFIX' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MIN_FILTER_PRICE_PREFIX'),
				'LOGIC' => static::GetLogic(array(BT_COND_LOGIC_EQ, BT_COND_LOGIC_NOT_EQ, BT_COND_LOGIC_GR, BT_COND_LOGIC_LS, BT_COND_LOGIC_EGR, BT_COND_LOGIC_ELS)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
		...
		while($arPriceType = $dbPriceType->Fetch()){
			...
			'CondIBMaxPrice'.$arPriceType['NAME'] => array(
				...
				'FIELD_TYPE' => 'int',
				'LABEL' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MAX_PRICE').' '.$arPriceType['NAME_LANG'],
				'PREFIX' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MAX_PRICE_PREFIX').' '.$arPriceType['NAME_LANG'],
				'LOGIC' => static::GetLogic(array(BT_COND_LOGIC_EQ, BT_COND_LOGIC_NOT_EQ, BT_COND_LOGIC_GR, BT_COND_LOGIC_LS, BT_COND_LOGIC_EGR, BT_COND_LOGIC_ELS)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
			...
			'CondIBMinPrice'.$arPriceType['NAME'] => array(
				...
				'FIELD_TYPE' => 'int',
				'LABEL' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MIN_PRICE').' '.$arPriceType['NAME_LANG'],
				'PREFIX' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MIN_PRICE_PREFIX').' '.$arPriceType['NAME_LANG'],
				'LOGIC' => static::GetLogic(array(BT_COND_LOGIC_EQ, BT_COND_LOGIC_NOT_EQ, BT_COND_LOGIC_GR, BT_COND_LOGIC_LS, BT_COND_LOGIC_EGR, BT_COND_LOGIC_ELS)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
			...
			'CondIBMaxFilterPrice'.$arPriceType['NAME'] => array(
				...
				'FIELD_TYPE' => 'int',
				'LABEL' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MAX_FILTER_PRICE').' '.$arPriceType['NAME_LANG'],
				'PREFIX' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MAX_FILTER_PRICE_PREFIX').' '.$arPriceType['NAME_LANG'],
				'LOGIC' => static::GetLogic(array(BT_COND_LOGIC_EQ, BT_COND_LOGIC_NOT_EQ, BT_COND_LOGIC_GR, BT_COND_LOGIC_LS, BT_COND_LOGIC_EGR, BT_COND_LOGIC_ELS)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
			...
			'CondIBMinFilterPrice'.$arPriceType['NAME'] => array(
				...
				'FIELD_TYPE' => 'int',
				'LABEL' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MIN_FILTER_PRICE').' '.$arPriceType['NAME_LANG'],
				'PREFIX' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MIN_FILTER_PRICE_PREFIX').' '.$arPriceType['NAME_LANG'],
				'LOGIC' => static::GetLogic(array(BT_COND_LOGIC_EQ, BT_COND_LOGIC_NOT_EQ, BT_COND_LOGIC_GR, BT_COND_LOGIC_LS, BT_COND_LOGIC_EGR, BT_COND_LOGIC_ELS)),
				'JS_VALUE' => array(
					'type' => 'input'
				),
			        ...
			        {         
				        ...
				        if ('L' == $arProp['PROPERTY_TYPE'])
				        {
                            ...
                            $arControlList['CondIBMaxFilterProperty'.$intIBlockID.':'.$arProp['ID']] = array(
                                ...
                                'FIELD_TYPE' => 'int',
                                'LABEL' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MAX_FILTER_PRICE').' '.$arProp['NAME'],
                            ...
                            $arControlList['CondIBMinFilterProperty'.$intIBlockID.':'.$arProp['ID']] = array(
                                ...
                                'FIELD_TYPE' => 'int',
                                'LABEL' => Loc::getMessage('BT_MOD_CATALOG_COND_CMP_MIN_FILTER_PRICE').' '.$arProp['NAME'],
