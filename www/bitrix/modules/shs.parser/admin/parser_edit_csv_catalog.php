...
<?
//********************
//Òîðãîâûå ïðåäëîæåíèÿ
//********************
if(!$hideCatalog):
$tabControl->BeginNextTab();
?> 
    <tr>
        <td class="field-name" width="40%"><?echo GetMessage("parser_offer_load_preview_or_detail")?></td> <!--ÐŸÐ°Ñ€ÑÐ¸Ñ‚ÑŒ ÑÐ¾ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñ‹ ÐºÐ°Ñ‚Ð°Ð»Ð¾Ð³Ð°:-->
    ...
    <tr>
        <td class="field-name" width="40%"><?echo GetMessage("parser_offer_one_selector")?>:</td> <!--Ð¡ÐµÐ»ÐµÐºÑ‚Ð¾Ñ€ ÐºÐ¾Ð½Ñ‚ÐµÐ¹Ð½ÐµÑ€Ð° Ð¾Ñ‚Ð´ÐµÐ»ÑŒÐ½Ð¾Ð¹ Ñ…Ð°Ñ€Ð°ÐºÑ‚ÐµÑ€Ð¸ÑÑ‚Ð¸ÐºÐ¸ Ð¾Ñ„Ñ„ÐµÑ€Ð°-->
    ...
    <tr> <!--Ð”Ð°Ð½Ð½Ð¾Ðµ Ð¿Ð¾Ð»Ðµ Ð´Ð»Ñ Ð²Ñ‹Ð³Ñ€ÑƒÐ·ÐºÐ¸ Ð¾Ñ„Ñ„ÐµÑ€Ð¾Ð² Ñ Ð¾Ð´Ð½Ð¾Ð¹ Ñ…Ð°Ñ€Ð°ÐºÑ‚ÐµÑ€Ð¸ÑÑ‚Ð¸ÐºÐ¾Ð¹-->
        <td class="field-name" width="40%"><?echo GetMessage("parser_catalog_delete_symb")?></td>
   ...
   <tr>
    ...
    <tr class="heading">
        <td colspan="2"><?echo GetMessage("parser_offer_more_props_descr")?></td>  <!--Ð¡Ð²Ð¾Ð¹ÑÑ‚Ð²Ð° Ñ‚Ð¾Ñ€Ð³Ð¾Ð²Ð¾Ð³Ð¾ Ð¿Ñ€ÐµÐ´Ð»Ð¾Ð¶ÐµÐ½Ð¸Ñ-->
    </tr>
    <tr>
        <td class="field-name" width="40%"><?echo GetMessage("parser_catalog_delete_symb")?></td>
        <td width="60%"><input type="text" name="SETTINGS[offer][catalog_delete_selector_props_symb]" value="<?echo $shs_SETTINGS["offer"]["catalog_delete_selector_props_symb"];?>" size="40" maxlength="250"></td>
    ...
    <tr class="heading">
        <td colspan="2"><?echo GetMessage("parser_offer_more_add_name_heading")?></td> <!--ÐÐ°Ð·Ð²Ð°Ð½Ð¸Ðµ Ñ‚Ð¾Ñ€Ð³Ð¾Ð²Ð¾Ð³Ð¾ Ð¿Ñ€ÐµÐ´Ð»Ð¾Ð¶ÐµÐ½Ð¸Ñ-->
    </tr>
    <tr>
   ...
   <tr>
    ...
    <tr class="heading">
        <td colspan="2"><?echo GetMessage("parser_offer_parsing_selector")?></td> <!--ÐŸÐ°Ñ€ÑÐ¸Ð½Ð³ Ð¿Ð¾Ð»ÐµÐ¹ Ð¸ ÑÐ²Ð¾Ð¹ÑÑ‚Ð² Ð¿Ð¾ ÑÐµÐ»ÐµÐºÑ‚Ð¾Ñ€Ñƒ-->
    </tr>
    <tr>
        <td class="field-name" width="40%"><?echo GetMessage("parser_catalog_delete_symb")?></td>
        <td width="60%"><input type="text" name="SETTINGS[offer][catalog_delete_selector_props_symb]" value="<?echo $shs_SETTINGS["offer"]["catalog_delete_selector_props_symb"];?>" size="40" maxlength="250"></td>
